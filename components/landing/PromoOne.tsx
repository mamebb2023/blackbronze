...
const PromoOne = () => {
  return (
    <div className="min-h-screen flex-center p-7">
      ...
      >
        <p className="text-transparent bg-clip-text bg-gradient-to-br from-white to-bronze-300 leading-14">
        ...
        <p className="text-transparent bg-clip-text bg-gradient-to-bl from-white to-bronze-300 leading-14">
